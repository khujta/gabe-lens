...
(function () {
  ...
  function build(C4, LV, o) {
    ...
    function applyBaked() { var B = window.GABE_BAKED && window.GABE_BAKED[o.fixture]; var hit = 0; nodes.forEach(function (n) { var p = B && B.pos && B.pos[n.id.replace(/#c\d+$/, '')]; if (p) { hit++; n.bx = p[0]; n.by = p[1]; n.bz = p.length > 2 ? p[2] : 0; } else { n.bx = n.by = n.bz = null; } }); return { hit: hit, of: nodes.length, meta: B && B.meta || null }; }
